...
;; Customize desktop-save behavior
...
;; Save the desktop automatically
...
;; Save frame configuration and other desktop options
...
;; Disable desktop file warning when the file is missing
(setq desktop-load-locked-desktop t)

;; Save buffers automatically every 5 minutes
(run-with-timer 60 (* 5 60) 'desktop-save-in-desktop-dir)
...
(defun update-time-since-last-modified ()
  "Update the time since last modified in the mode line."
...
(defun monitor-buffer-modifications ()
  ...
  (update-buffer-last-modified-time)
  (update-time-since-last-modified))
